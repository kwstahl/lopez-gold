        ...
        <div className="w-[375px] bg-white rounded-3xl shadow-2xl overflow-hidden border border-gray-200">
          ...
          <div className="bg-white max-h-[812px] overflow-y-auto">
            ...
            <div className="px-6 py-6">
              <h2 className="text-2xl text-[#111111] mb-2">Classic Gold Ring</h2>
              <p className="text-2xl text-[#111111] mb-4">$2,850</p>
              
              <div className="py-3 px-4 bg-[#F5F5F5] rounded-lg mb-6">
                <p className="text-sm text-gray-700">Pay in 4 interest-free installments of $712.50</p>
              </div>
              ...
              <div className="mb-6">
                ...
                <div className="flex items-center gap-4">
                  <button
                    ...
                    className="w-10 h-10 rounded-full bg-[#F5F5F5] flex items-center justify-center hover:bg-gray-200 transition-colors"
                  >
                    <Minus className="w-4 h-4 text-[#111111]" />
                  </button>
                  <span className="text-lg text-[#111111] min-w-[2rem] text-center">{quantity}</span>
                  <button
              ...
              <div className="border-t border-gray-100 pt-6 mb-6">
                ...
                <p className="text-sm text-gray-700 leading-relaxed">
                  Handcrafted 18k gold ring featuring a timeless design. Each piece is carefully made by our artisans 
                  using ethically sourced materials. This ring represents elegance and quality craftsmanship.
                </p>
              </div>
